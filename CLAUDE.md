...
MCP server for media requests (MooGPT's `media_requests` tool group — the Hollywood assistant was retired 2026-07-26): search/request/discover via Seerr, read-only download queue via Radarr/Sonarr.
